...
public class RequestHandlerServiceServiceLocator extends org.apache.axis.client.Service implements pension.up.RequestHandlerServiceService {
    ...
    private java.lang.String RequestHandlerService_address = "http://localhost:8080/Pensioner_SOA_Client/services/RequestHandlerService";
    ...
    public pension.up.RequestHandlerService getRequestHandlerService() throws javax.xml.rpc.ServiceException {
    ...
    public pension.up.RequestHandlerService getRequestHandlerService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            pension.up.RequestHandlerServiceSoapBindingStub _stub = new pension.up.RequestHandlerServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (pension.up.RequestHandlerService.class.isAssignableFrom(serviceEndpointInterface)) {
                pension.up.RequestHandlerServiceSoapBindingStub _stub = new pension.up.RequestHandlerServiceSoapBindingStub(new java.net.URL(RequestHandlerService_address), this);
                _stub.setPortName(getRequestHandlerServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://up.pension", "RequestHandlerServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://up.pension", "RequestHandlerService"));
        }
